# SIEM Lab: Attack Detection & Analysis Using Splunk
...
## 1️⃣ SSH Brute-Force Attack (Failed Logins)
...
2️⃣ Successful Login After Brute Force
Attack Description
...
3️⃣ Privilege Escalation (Sudo Abuse)
Attack Description
...
4️⃣ Suspicious Execution from /tmp
Attack Description
...
6️⃣ Backdoor User with Sudo Privileges
Attack Description
